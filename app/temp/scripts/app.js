...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wikiViewer = __webpack_require__(2);

	var _wikiViewer2 = _interopRequireDefault(_wikiViewer);

	var _searchbarAnimate = __webpack_require__(3);

	var _searchbarAnimate2 = _interopRequireDefault(_searchbarAnimate);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var wikipediaViewer = (0, _wikiViewer2.default)();
	var animateSearch = (0, _searchbarAnimate2.default)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function searchbarAnimate() {
	  (0, _jquery2.default)('#new_search').on('focus', function () {
	    (0, _jquery2.default)(this).parent('label').addClass('active');
	  });
	  (0, _jquery2.default)('#new_search').on('blur', function () {
	    if ((0, _jquery2.default)(this).val().length === 0) {
	      (0, _jquery2.default)(this).parent('label').removeClass('active');
	    }
	  });
	}

	exports.default = searchbarAnimate;
